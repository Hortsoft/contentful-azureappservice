...
import { MetaTags } from '../../../interfaces/tags';
    ...
    return (
        <Fragment>
            <Head>
                ...
                {tags.description ?
                    <meta name="twitter:description" key="twitter_description" content={tags.description}/> : null}

                {/* Twitter account */}
                {tags.twitter_site ?
                    <meta name="twitter:site" key="twitter_site" content={tags.twitter_site}/> : null
                }
                {/* Name of Website */}
                {tags.twitter_domain ?
                ...
                {tags.twitter_site ?
                    <meta name="twitter:image:src" key="twitter_img" content={tags.image}/> : null}
